...
/*
$uriPathStatic='melhoramentos/public';

if(file_exists($_SERVER['DOCUMENT_ROOT'] .'/'. $uriPathStatic)){
	$baseUrl='/'.$uriPathStatic.$baseUrl;
}

$baseUrlSimple=$baseUrl;
$baseUrl='http://'.$_SERVER['HTTP_HOST'].$baseUrl;

//$baseUrl=\madeam\Framework::url('/files/ckfinder/');
//*/
...
ATTENTION: The trailing slash is required.
*/
//$baseDir = resolveUrl($baseUrlSimple);
$baseDir = resolveUrl($baseUrl);
