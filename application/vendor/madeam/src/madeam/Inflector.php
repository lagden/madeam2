...
class Inflector {
	...
	*/
	public static function pluralize($word) {
		...
		if (array_key_exists(strtolower($word), static::$irregulars)) {
	...
	*/
	public static function singalize($word) {
		$pluralIrregulars = array_flip(static::$irregulars);
	...
	*/
	public static function underscorize($string) {
		return static::specialize('_', $string);
	}
	...
	*/
	public static function dashize($string) {
		return static::specialize('-', $string);
	}
	...
	*/
	public static function humanize($string) {
		return ucwords(preg_replace('/\s\s+/', ' ', static::specialize(' ', $string)));
	}
