...
class Router {
	...
	*/
	public static function connect($route, $values = array(), $rules = array()) {
		...
		// add to routes list
		static::$routes[] = array($regex, $values, $rules);
	}
	...
	*/
	public static function resource($name, $options = array()) {
		...
		static::connect("$name/:$id[0]",      array('_action' => 'show',    '_controller' => $name),  array('_method' => 'get', $id[0] => $id[1]));
		static::connect("$name/edit/:$id[0]", array('_action' => 'edit',    '_controller' => $name),  array('_method' => 'get', $id[0] => $id[1]));
		static::connect("$name/new",          array('_action' => 'new',     '_controller' => $name),  array('_method' => 'get'));
		static::connect("$name",              array('_action' => 'delete',  '_controller' => $name),  array('_method' => 'delete'));
		static::connect("$name",              array('_action' => 'update',  '_controller' => $name),  array('_method' => 'put'));
		static::connect("$name",              array('_action' => 'create',  '_controller' => $name),  array('_method' => 'post'));
		static::connect("$name",              array('_action' => 'index',   '_controller' => $name),  array('_method' => 'get'));
	}
